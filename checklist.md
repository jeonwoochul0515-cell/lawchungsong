...
## 언론·단체 게재글 백링크 요청 (2026-07-17) ❌ 보류 결정
...
- [x] 더버터(hello@thebutter.org), 이젠센터(egenhappy@egen.or.kr) 이메일 확인, 요청 문구 작성
- [x] 부산시 공익제보센터(청렴담당관) 연락처(전화만, 이메일 없음) 확인
- **2026-07-17: 사용자가 셋 다 보류 결정** — 더버터·이젠센터·부산시 공익제보 세 건 전부 발송하지 않기로 함. 재개 원하면 위 이메일·문구 그대로 재사용 가능
